...
move(controller=controller,Vl=5,Vr=5, D= 1300,T= 0.2) #move 1m
...
move(controller=controller,Vl=2.5 , Vr=2.5 , D=20, T= 0.2)#turn left
move(controller=controller,Vl=5,Vr=5, D= 1200,T= 0.2) #move 1m
move(controller=controller,Vl=5 , Vr=2.5 , D=20, T= 0.2)#turn left
